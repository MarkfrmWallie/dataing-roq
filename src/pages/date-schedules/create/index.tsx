...
import { createDateSchedule } from 'apiSdk/date-schedules';
...
function DateScheduleCreatePage() {
  ...
  const handleSubmit = async (values: DateScheduleInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createDateSchedule(values);
      resetForm();
